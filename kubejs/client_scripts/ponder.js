Ponder.tags(event => {
    event.createTag('kubejs:above_and_beyond', 'kubejs:andesite_machine', 'Above and Beyond', 'Special contraptions', [
...
Ponder.registry(event => {
    event.create('kubejs:alchemical_laser')
        .scene("alchemy_setup", "The Thermal Alchemy Setup", "kubejs:laser_alchemy", (scene, util) => {
            ...
            scene.overlay.showControls(new PonderInput(util.vector.blockSurface(util.grid.at(2, 1, 2), Facing.north), PonderPointing.RIGHT)
                .rightClick(),
                40)
            ...
            // let cartHandle = scene.special.createCart()
            scene.idle(20)
