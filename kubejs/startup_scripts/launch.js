...
StartupEvents.registry('item', event => {
	event.create('growing_small_quartz_bud', 'create:sequenced_assembly').texture("ae2:block/small_quartz_bud").displayName('Small Certus Quartz Bud')
	event.create('growing_medium_quartz_bud', 'create:sequenced_assembly').texture("ae2:block/medium_quartz_bud").displayName('Medium Certus Quartz Bud')
	event.create('growing_large_quartz_bud', 'create:sequenced_assembly').texture("ae2:block/large_quartz_bud").displayName('Large Certus Quartz Bud')
...
StartupEvents.registry('block',  event => {
	event.create('enderium_casing').model('kubejs:block/enderium_casing').soundType('metal').mapColor('metal').hardness(4.0).displayName('Ender Casing')
	event.create('zinc_casing').soundType('metal').mapColor('metal').hardness(3.0).displayName('Zinc Casing')
	event.create('invar_casing').soundType('metal').mapColor('metal').hardness(3.0).displayName('Invar Casing')
	event.create('fluix_casing').soundType('metal').mapColor('metal').hardness(3.0).displayName('Fluix Casing')
	...
	reagent(0x5F5F5F, 0x8E8E8E, "andesite", "Andesite", "chipped:cobbled_andesite")
	reagent(0x7F7F7F, 0xD4D4D4, "diorite", "Diorite", "chipped:cobbled_diorite")
	reagent(0x563A2F, 0x9A6C5B, "granite", "Granite", "chipped:cobbled_granite")
	...
	reagent(0x6B5D4F, 0x7D6B5A, "deepslate", "Deepslate", "minecraft:cobbled_deepslate")
	category()
