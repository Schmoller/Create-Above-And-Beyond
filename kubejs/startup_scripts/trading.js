...
StartupEvents.registry('item', event => {
	...
	while (true) {
		...
		simple("Deepslate", MC('cobbled_deepslate', 16), 3, S, 0x0D0706, 0x23201A)
		simple("Tuff", MC('tuff', 16), 3, S, 0x5F5F5F, 0x8E8E8E)
		simple("Calcite", MC('calcite', 16), 5, S, 0xC2C2C2, 0xDADADA)
